                                    ...
                                    return (
                                        ...
                                        >
                                            {appt ? (
                                                ...
                                                <div
                                                    className="h-16"
                                                    onContextMenu={(e) => onContextMenu(e, null, slot, doctor)}
                                                ></div>
                                            )}
                                        </div>
                                    );
                            ...
                            >
                                ...
                                {showStatusMenu && (
                                    <div className="absolute left-full top-0 bg-white border border-gray-200 shadow-lg rounded">
                                        <div
                                            onClick={() =>
                                                updateStatus(contextMenu.appointment.appointment_id, "scheduled")
                                            }
                                        ...
                                        <div
                                            onClick={() =>
                                                updateStatus(contextMenu.appointment.appointment_id, "arrived")
                                            }
                                            className="hover:bg-gray-100 px-4 py-2 cursor-pointer text-sm"
                                        >
                                            Arrived
                                        ...
                                        <div
                                            onClick={() =>
                                                updateStatus(contextMenu.appointment.appointment_id, "cancelled")
                                            }
                                            className="hover:bg-gray-100 px-4 py-2 cursor-pointer text-sm"
                                        >
                                            Cancelled
                                        ...
                                        <div
                                            onClick={() =>
                                                updateStatus(contextMenu.appointment.appointment_id, "rescheduled")
                                            }
                                            className="hover:bg-gray-100 px-4 py-2 cursor-pointer text-sm"
                                        >
                                            Rescheduled
                                        ...
                                        <div
                                            onClick={() =>
                                                updateStatus(contextMenu.appointment.appointment_id, "no_call_no_show")
                                            }
                                            className="hover:bg-gray-100 px-4 py-2 cursor-pointer text-sm"
                                        >
                                            No Call No Show
                                        ...
                                        <div
                                            onClick={() =>
                                                updateStatus(contextMenu.appointment.appointment_id, "cancelled_without_notice")
                                            }
                                            className="hover:bg-gray-100 px-4 py-2 cursor-pointer text-sm"
                                        >
